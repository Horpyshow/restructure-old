      ...
      <div class="mx-auto w-full max-w-md lg:w-96 animate-slide-in">
        ...
        <div class="mt-8 text-center">
          <p class="text-xs text-gray-500">
            © 2024 Wealth Creation ERP. All rights reserved. | Powered by Advanced Security
          </p>
        </div>
      </div>
    </div>
          ...
          <div class="text-center text-white px-8 max-w-lg">
            <div class="glass-effect rounded-3xl p-10 animate-fade-in">
              ...
              <p class="text-gray-600 leading-relaxed mb-8 text-lg">
                ...
                Manage resources, track performance, and drive growth with powerful analytics and real-time insights.
              </p>
